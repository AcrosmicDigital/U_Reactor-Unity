...
namespace U.Reactor
{
    public class HorizontalLayoutGroupSetter
    {
        ...
        public HorizontalLayoutGroup Set(HorizontalLayoutGroup c)
        {
            c.padding = padding;
            c.spacing = spacing;
        ...
        public HorizontalLayoutGroup Set(GameObject gameObject)
        {
