...
namespace U.Reactor
{
    public class RElabel : RErenderer
    {
        ...
        protected override REbaseSelector AddSelector() => new Selector(gameObject, idCmp, rectTransformCmp, canvasRendererCmp, textCmp, imageCmp);
        ...
        public static Selector CastSelector(REbaseSelector selector)
        {
            ...
            {
                Debug.Log("RElabel: Cant cast selector");
                return null;
            }
        }
