...
namespace U.Reactor
{
    public class REtext : RErenderer
    {
        ...
        protected override REbaseSelector AddSelector() => new Selector(gameObject, idCmp, rectTransformCmp, canvasRendererCmp, textCmp);
        ...
        public static Selector CastSelector(REbaseSelector selector)
        {
            ...
            {
                Debug.Log("REtext: Cant cast selector");
                return null;
            }
        }
