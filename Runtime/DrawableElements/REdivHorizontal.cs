...
namespace U.Reactor
{
    public class REdivHorizontal : RErenderer
    {
        ...
        protected override REbaseSelector AddSelector() => new Selector(gameObject, idCmp, rectTransformCmp, canvasRendererCmp, scrollRectCmp, rectMask2Cmp, horizontalLayoutCmp, contentSizeCmp,
        ...
        public static Selector CastSelector(REbaseSelector selector)
        {
            ...
            {
                Debug.Log("REdivHorizontal: Cant cast selector");
                return null;
            }
        }
