...
namespace U.Reactor
{
    public class REdivVertical : RErenderer
    {
        ...
        protected override void AddComponents()
        {
            ...
            new RectTransformBSetter()
            {
                ...
                anchorMax = new Vector2(1, 1f),
                sizeDelta = new Vector2(vScrollbar.height, 0f),  // 20,0
        ...
        protected override REbaseSelector AddSelector() => new Selector(gameObject, idCmp, rectTransformCmp, canvasRendererCmp, scrollRectCmp, rectMask2Cmp, verticalLayoutCmp, contentSizeCmp,
        ...
        {
            public override string name { get; set; } = "Div Vertical";
        }
        ...
        public static Selector CastSelector(REbaseSelector selector)
        {
            ...
            {
                Debug.Log("REdivVertical: Cant cast selector");
                return null;
            }
        }
