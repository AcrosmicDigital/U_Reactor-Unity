...
namespace U.Reactor
{
    public class REtoggle : REbase
    {
        ...
        protected override REbaseSelector AddSelector() => new Selector(gameObject, idCmp, rectTransformCmp, toggleCmp, backImageCmp, checkImageCmp, textCmp, multiToggleMemberCmp);
