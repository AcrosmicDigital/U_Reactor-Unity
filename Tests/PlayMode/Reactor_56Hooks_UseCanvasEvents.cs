...
public class Reactor_56Hooks_UseCanvasEvents
{
    ...
    [UnityTest]
    public IEnumerator Hooks_UseUpdate_10Basics()
    {
    ...
    [UnityTest]
    public IEnumerator Hooks_UseUpdate_11TimeMode()
    {
    ...
    [UnityTest]
    public IEnumerator Hooks_UseUpdate_60ThrowErrorInDeltaFunction()
    {
    ...
    [UnityTest]
    public IEnumerator Hooks_UseUpdate_30InHidedElements_RunNormally()
    {
    ...
    [UnityTest]
    public IEnumerator Hooks_UseUpdate_32InErasedElements_WillBeErasedToo()
    {
