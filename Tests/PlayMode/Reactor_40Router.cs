...
public class Reactor_40Router
{
    ...
    REcanvas Menu()
    {
        return new REcanvas
        {
            propsId = () => new REcanvas.IdSetter { id = "Menu" },
    ...
    REcanvas Home()
    {
        return new REcanvas
        {
            propsId = () => new REcanvas.IdSetter { id = "Home" },
    ...
    REcanvas Settings()
    {
        return new REcanvas
        {
            propsId = () => new REcanvas.IdSetter { id = "Settings" },
    ...
    REcanvas Default()
    {
        return new REcanvas
        {
            propsId = () => new REcanvas.IdSetter { id = "Default" },
