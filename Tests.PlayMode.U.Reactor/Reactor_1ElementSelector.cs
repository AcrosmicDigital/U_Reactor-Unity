                ...
                childs = () => new ReactorElement[] {
                        new REpanel {
                            ...
                            childs = () => new ReactorElement[]
                            {
                                ...
                                new REpanel{ propsGameObject = () => new GameObjectSetter{ name = "PanelMain1-PanelChild3"} },
                                new REpanel{ propsGameObject = () => new GameObjectSetter{ name = "PanelMain1-PanelChild4"} },
                            },
                        },
                        new REpanel {
                        ...
                        new REpanel{ propsGameObject = () => new GameObjectSetter{ name = "PanelMain3"} },
                        new REpanel{ propsGameObject = () => new GameObjectSetter{ name = "PanelMain4"} },
                    },
