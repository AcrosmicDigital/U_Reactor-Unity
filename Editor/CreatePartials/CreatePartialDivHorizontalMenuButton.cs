...
{
    public class CreatePartialDivHorizontalMenuButton : EditorWindow
    {

        #region File
        private static string DefaultFolderName => "/Scripts/Reactor/Partials/";
        private static string DefaultFileName => "New";
        private static string CustomExtension => "divhoriz.partial";
        static string[] File(string fileName) => new string[]
        {
            ...
            "{",
            "    public static partial class DivsHorizontal",
            "    {",
            "        public static REdivHorizontal "+fileName+"(",
            "            Func<REdivHorizontal.RectTransformSetter> propsRectTransform,",
        ...
        [MenuItem("Universal/Reactor/Create/Partial/Div Horizontal")]
