...
{
    public class CreatePartialMultiToggleMenuButton : EditorWindow
    {

        #region File
        private static string DefaultFolderName => "/Scripts/Reactor/Partials/";
        private static string DefaultFileName => "New";
        private static string CustomExtension => "multitggl.partial";
        static string[] File(string fileName) => new string[]
        {
            ...
            "{",
            "    public static partial class MultiToggles",
            "    {",
            "        public static REmultiToggle "+fileName+"(",
            "            Func<REmultiToggle.RectTransformSetter> propsRectTransform,",
        ...
        [MenuItem("Universal/Reactor/Create/Partial/MultiToggle")]
