...
namespace U.Reactor.Editor
{
    public class CreatePartialBoxMenuButton : EditorWindow
    {
        ...
        static string[] File(string fileName) => new string[]
        {
            ...
            "{",
            "    public static partial class Boxes",
            "    {",
            "        public static REbox "+fileName+"(",
            "            Func<REbox.RectTransformSetter> propsRectTransform,",
        ...
        [MenuItem("Universal/Reactor/Create/Partial/Box")]
