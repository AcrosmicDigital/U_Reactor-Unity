...
{
    public class CreatePartialPanelVerticalMenuButton : EditorWindow
    {

        #region File
        private static string DefaultFolderName => "/Scripts/Reactor/Partials/";
        private static string DefaultFileName => "New";
        private static string CustomExtension => "panelvert.partial";
        static string[] File(string fileName) => new string[]
        {
            ...
            "{",
            "    public static partial class PanelsVertical",
            "    {",
            "        public static REpanelVertical "+fileName+"(",
            "            Func<REpanelVertical.RectTransformSetter> propsRectTransform,",
        ...
        [MenuItem("Universal/Reactor/Create/Partial/Panel Vertical")]
